    ...
    return (
        <Body>
            ...
            <Form onSubmit={signUp}>
                <input disabled={disabled} type="text" placeholder="Nome" required onChange={(e) => setName(e.target.value)} value={name} />
                ...
                <input disabled={disabled} type="password" placeholder="Confirme a senha" required onChange={(e) => setConfirmPassword(e.target.value)} value={confirmPassword} />
